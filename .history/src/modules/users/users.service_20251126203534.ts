...
export class UsersService {
  ...
  async create(createUserDto: CreateUserDto) {
    // Social login flow: The user's password field (if exists) is often handled separately 
    // or set to a placeholder, as the external provider handles authentication.
